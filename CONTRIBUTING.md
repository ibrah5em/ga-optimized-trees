...
1. **Update README.md** if introducing new features
1. **Create PR** with clear description and references to issues
...
1. **Alternatives Considered**: Other approaches you've considered
