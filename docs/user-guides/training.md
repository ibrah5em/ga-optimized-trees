...
1. `n_generations` (20-100)
1. `accuracy_weight` (0.5-0.9)
1. `max_depth` (4-8)
...
1. Increase generations (30 → 60)
1. Adjust mutation probability (0.18 → 0.25)
1. Check feature scaling (standardize data)
...
1. Increase node_complexity weight (0.50 → 0.70)
1. Decrease max_depth (6 → 4)
1. Increase prune_subtree mutation (0.25 → 0.40)
...
1. Increase min_samples_leaf (3 → 5)
1. Regularize with interpretability weight
